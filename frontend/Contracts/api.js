...
const API_CONTRACTS_BASE = "http://localhost:8000/api/contracts";
const API_TENANTS_BASE = "http://localhost:8000/api/tenants";
const API_BUILDINGS_BASE = "http://localhost:8000/api/buildings";
